...
# 		quest2.save!
		...
		LifeTape::Category.create!(:name => 'Социальные проблемы', :short_desc => "Южный Треугольник, и в этом вопросе достигнута такая точность расчетов, что, начиная с того дня, как мы видим, произошло в царствование Ромула. Движение меняет вращательный натуральный логарифм в , было вычислено время предшествовавших затмений солнца." )
		LifeTape::Category.create!(:name => 'Проблемы при обучении', :short_desc => "Южный Треугольник, и в этом вопросе достигнута такая точность расчетов, что, начиная с того дня, как мы видим, произошло в царствование Ромула. Движение меняет вращательный натуральный логарифм в , было вычислено время предшествовавших затмений солнца." )
