  ...
  def score(status)
    if status.nil? or status == 0
      ...
      post_aspects.others(self.post).each do |tr|
        ...
        on_i=(tr.on1+tr.on2+tr.on3+tr.on4) ==0 ? 0 :  33.33 * (3*tr.on1+2*tr.on2+1*tr.on3)/(tr.on1+tr.on2+tr.on3+tr.on4)
        ozf_i=(tr.ozf1+tr.ozf2+tr.ozf3+tr.ozf4) ==0 ? 0 : 33.33 * (3*tr.ozf1+2*tr.ozf2+1*tr.ozf3)/(tr.ozf1+tr.ozf2+tr.ozf3+tr.ozf4)
        ozs_i=(tr.ozs1+tr.ozs2+tr.ozs3+tr.ozs4) ==0 ? 0 : 33.33 * (3*tr.ozs1+2*tr.ozs2+1*tr.ozs3)/(tr.ozs1+tr.ozs2+tr.ozs3+tr.ozs4)
      ...
      @max_score == 0 ? 0.0 : ((sum_all*100/ @max_score) *1000).round / 1000.0
    end
