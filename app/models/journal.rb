class Journal < ActiveRecord::Base
  ...
  @types = %w(enter)
  @my_types = %w(my_life_tape_comment my_discontent_comment other_life_tape_comment other_discontent_comment my_concept_comment my_discontent_note my_concept_note my_add_score_comment)
