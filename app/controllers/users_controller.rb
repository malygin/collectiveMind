class UsersController < ProjectsController
  ...
  def show
    redirect_to polymorphic_path(@project.status == 100 ? :plan_posts : @project.current_stage_type, project: @project, action: :user_content, edit_profile: true) if @user == current_user
