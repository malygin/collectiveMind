...
<nav id="sidebar" class="sidebar nav-collapse collapse">
    <ul id="side-nav" class="side-nav">
        ...
        <li class="active panel">
            ...
            <ul id="components-collapse" class="panel-collapse in">
                ...
                <li class="active"><a href="component_fileupload.html">Fileupload</a></li>
...
<div class="wrap">
    ...
    <div class="content container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">Fileupload <small>Drag & drop fileupload</small></h2>
            </div>
        </div>
        <div class="row">
