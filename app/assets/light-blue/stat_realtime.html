...
<nav id="sidebar" class="sidebar nav-collapse collapse">
    <ul id="side-nav" class="side-nav">
        ...
        <li class="active panel">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#side-nav" href="#stats-collapse"><i class="fa fa-bar-chart-o"></i> <span class="name">Statistics</span></a>
            <ul id="stats-collapse" class="panel-collapse in">
                <li><a href="stat_statistics.html">Stats</a></li>
                <li><a href="stat_charts.html">Charts</a></li>
                <li class="active"><a href="stat_realtime.html">Realtime</a></li>
            </ul>
        </li>
        <li class="panel">
            <a class="accordion-toggle collapsed" data-toggle="collapse"
...
<div class="wrap">
    ...
    <div class="content container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">Realtime Chart <small>Realtime data</small></h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-10 offset1">
                <section class="widget">
                    ...
                    <div class="body row">
                        ...
                        <div class="col-sm-10" id="chart-container">
...
<script src="lib/rickshaw/rickshaw-extensions.js"></script>
