    ...
    <ul id="side-nav" class="side-nav">
        ...
        <li class="active panel">
            ...
            <ul id="components-collapse" class="panel-collapse in">
                ...
                <li class="active"><a href="component_list_groups.html">List Groups &nbsp; <span class="label label-important">new</span></a></li>
            </ul>
        </li>
        <li class="panel">
            <a class="accordion-toggle collapsed" data-toggle="collapse"
...
<div class="content container">
    <div class="row">
        <div class="col-md-12">
            <h2 class="page-title">List Groups <small>Sortable Lists</small></h2>
        </div>
    </div>
    <div class="row">
        <div class="col-md-10">
            <h4>Closest stars</h4>
            <ol class="list-group list-group-outer sortable">
...
<script src="js/list-groups.js"> </script>
