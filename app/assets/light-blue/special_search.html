    ...
    <ul id="side-nav" class="side-nav">
        ...
        <li class="active panel">
            ...
            <ul id="special-collapse" class="panel-collapse in">
                <li class="active"><a href="special_search.html">Search</a></li>
...
<div class="wrap">
    ...
    <div class="content container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">Search Results <small>Search result and form</small></h2>
            </div>
        </div>
        <div class="row">
                                ...
                                <form class="form-inline form-search no-margin text-align-center" role="form">
                                    <div class="input-group">
                                        <input type="search" class="form-control"
                                               placeholder="Keywords: Node.js, History">
                ...
                <section class="widget padding-increased">
                    ...
                    <div class="body no-margin">
                        <section class="search-result">
                            <h4>Next generation admin template</h4>
                        ...
                        <section class="search-result">
                            <h4>Can I use CSS3 Radial-Gradient?</h4>
                            <p class="text-success"><small>okendoken.com</small></p>
                        ...
                        <section class="search-result">
                            <h4>The origins of the Grand Duchy of Litva</h4>
                            <p class="text-success"><small>www.belarusguide.com</small></p>
