    ...
    <ul id="side-nav" class="side-nav">
        ...
        <li class="active panel">
            ...
            <ul id="components-collapse" class="panel-collapse in">
                ...
                <li class="active"><a href="component_bootstrap.html">Bootstrap &nbsp; <span class="label label-important">new</span></a></li>
...
<div class="content container">
    <div class="row">
        <div class="col-md-12">
            <h2 class="page-title">Bootstrap Components <small>Built-in components</small></h2>
        ...
        <div class="col-md-6">
            <section class="widget">
                <div class="jumbotron">
                    <div class="container">
                        <h1>Hello, world!</h1>
                        <p class="lead"><em>Amazing</em> content</p>
                        <p>
