    ...
    <ul id="side-nav" class="side-nav">
        ...
        <li class="active panel">
            ...
            <ul id="components-collapse" class="panel-collapse in">
                ...
                <li class="active"><a href="component_maps.html" data-no-pjax>Maps</a></li>
            ...
            <div class="col-md-6">
                <section class="widget large">
                    <header>
                        ...
                        <div class="actions">
                            <input id="address" type="text" class="input-transparent" placeholder="Enter Address">
                        </div>
                    </header>
                    <div class="body">
                        <div class="map">
...
<script src="lib/jquery.vmap.europe.js"></script>
<script src="lib/jquery.vmap.usa.js"></script>
<script src="lib/jquery.vmap.australia.js"></script>
