                ...
                <div class="body">
                    <form class="form-horizontal" method="post">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls form-group">
                                <div class="col-sm-8"><input type="text" id="tooltip-enabled" class="form-control"
                                       data-placement="top" data-original-title="Some explanation text here"
                                       placeholder="Hover over me.."></div>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label " for="disabled-input">Disabled input</label>
                            <div class="controls form-group">
                                <div class="col-sm-8"><input type="text" id="disabled-input" class="form-control"
                                       disabled="disabled" value="Default value" ></div>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label " for="max-length">Max length</label>
                            <div class="controls form-group">
                                <div class="col-sm-8"><input type="text" id="max-length" maxlength="3"
                                       class="form-control"
                                       placeholder="Max length 3 characters"
                                       data-placement="top" data-original-title="You cannot write more than 3 characters."></div>
                            </div>
                        </div>
                        <div class="control-group">
                    ...
                    <form class="form-horizontal form-condensed" action="#">
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls form-group">
                                    <textarea rows="3" class="autogrow form-control" id="elastic-textarea"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls form-group">
                                    <select id="country" required="required"
                                            data-placeholder="Select country" class="select-block-level chzn-select"
                                            tabindex="-1"
                                            name="country">
                                        <option value=""></option>
                    ...
                    <form class="form-horizontal" method="post">
                        <fieldset>
                            <div class="control-group">
                                ...
                                <div class="controls form-group">
                                    <label class="checkbox">
                                        <input type="checkbox" id="checkbox-1" checked="checked" class="iCheck">
                                        Not so much needs to be done </label>
                                    <label class="checkbox">
                                        <input type="checkbox" id="checkbox-2" class="iCheck">
                                        It's really hard to generate random text </label>
                                    <label class="checkbox">
                                        <input type="checkbox" id="checkbox-3" class="iCheck">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls form-group">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="checkbox-4" class="iCheck" value="true" checked="checked">
                                        True </label>
                                    <label class="checkbox inline">
                                        <input type="checkbox" value="false" class="iCheck" id="checkbox-5">
                                        False </label>
                                    <label class="checkbox inline">
                                        <input type="checkbox" value="disabled" class="iCheck" id="checkbox-6"
                                               checked="checked"
                                                disabled="disabled">
                                        Disabled </label>
                                </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls form-group">
                                    <label class="radio">
                                        <input type="radio" id="radio-4" class="iCheck" name="can" checked="checked">
                                        We can sing</label>
                                    <label class="radio">
                                        <input type="radio" name="can" class="iCheck" id="radio-5">
                                        We can dance </label>
                                    <label class="radio">
                                        <input type="radio" name="can" class="iCheck" id="radio-6">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls form-group">
                                    <label class="radio inline">
                                        <input type="radio" id="radio-1" class="iCheck" name="cani" checked="checked">
                                        Sing</label>
                                    <label class="radio inline">
                                        <input type="radio" name="cani" class="iCheck" id="radio-2">
                                        Dance </label>
                                    <label class="radio inline">
                                        <input type="radio" name="cani" class="iCheck" id="radio-3">
                                        Best </label>
                                </div>
                            </div>
                            <div class="control-group">
                        ...
                        <fieldset>
                            ...
                            <div class="row"><div class="col-sm-8">
                                <div class="control-group">
                                    ...
                                    <div class="input-group">
                                        <input id="color" class="form-control colorpicker" type="text" name="color"
                                               value="#eac85e">
    ...
    <div class="row">
        <div class="col-md-12">
            <section class="widget">
                <header>
                    <h4>
                        Sliders <span class="label label-danger">new</span>
                    </h4>
                </header>
                <div class="body">
                    <div class="row">
