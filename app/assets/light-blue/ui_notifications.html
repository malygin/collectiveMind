    ...
    <ul id="side-nav" class="side-nav">
        ...
        <li class="active panel">
            ...
            <ul id="ui-collapse" class="panel-collapse in">
                ...
                <li class="active"><a href="ui_notifications.html">Notifications &nbsp;<span class="label label-danger">new</span></a></li>
...
<!-- page specific libs -->
<script src="lib/messenger-1.4.1/messenger.js"></script>
<script src="lib/messenger-1.4.1/messenger-theme-flat.js"></script>

<!-- demo-only libs -->
<script src="lib/backbone/backbone-min.js"></script>
<script src="lib/messenger-1.4.1/docs/welcome/javascripts/location-sel.js"></script>
