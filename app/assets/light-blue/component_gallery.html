    ...
    <ul id="side-nav" class="side-nav">
        ...
        <li class="active panel">
            ...
            <ul id="components-collapse" class="panel-collapse in">
                ...
                <li class="active"><a href="component_gallery.html">Gallery</a></li>
...
<div class="wrap">
    ...
    <div class="content container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">Media Gallery <small>Images, videos and more</small></h2>
            </div>
        </div>
        <div class="row">
                        ...
                        <ul class="row thumbnails">
                            ...
                            <li class="col-sm-4">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h4>Thumbnail label</h4>
                                        <p>No hesitation. You ask me: “What to do with
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-danger pull-left btn-sm"> <i class="fa fa-angle-left"></i> Previous</button>
                        <button class="btn btn-danger btn-sm">&nbsp; Next <i class="fa fa-angle-right"></i>  &nbsp; </button>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        </div><!-- /.modal -->
