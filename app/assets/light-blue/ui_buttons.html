...
<div class="wrap">
    ...
    <div class="content container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">Buttons <small>Buttons, states and more</small></h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-default"
                                            data-placement="top" data-original-title=".btn .btn-default">
                                        Default
                                    </button>
                                </div>
                                <div class="col-xs-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-warning"
                                            data-placement="top" data-original-title=".btn .btn-warning">
                                        Warning
                                    </button>
                                </div>
                                <div class="col-xs-4">
                            ...
                            <div class="row">
                                <div class="col-xs-4 col-sm-offset-4">
                                    <button type="button" class="btn btn-inverse"
                                            data-placement="top" data-original-title=".btn .btn-inverse">
                                        Inverse
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-default btn-sm"
                                            data-placement="top" data-original-title=".btn .btn-default .btn-sm">
                                        Default
                                    </button>
                                </div>
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-primary btn-sm"
                                            data-placement="top" data-original-title=".btn .btn-primary .btn-sm">
                                        Primary
                                    </button>
                                </div>
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-info btn-sm"
                                            data-placement="top" data-original-title=".btn .btn-info .btn-sm">
                                        &nbsp;Info&nbsp;
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-success btn-sm"
                                            data-placement="top" data-original-title=".btn .btn-success .btn-sm">
                                        Success
                                    </button>
                                </div>
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-warning btn-sm"
                                            data-placement="top" data-original-title=".btn .btn-warning .btn-sm">
                                        Warning
                                    </button>
                                </div>
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-danger btn-sm"
                                            data-placement="top" data-original-title=".btn .btn-danger .btn-sm">
                                        Danger
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-4 col-sm-offset-4">
                                    <button type="button" class="btn btn-inverse btn-sm"
                                            data-placement="top" data-original-title=".btn .btn-inverse .btn-sm">
                                        Inverse
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-default btn-lg"
                                            data-placement="top" data-original-title=".btn .btn-default .btn-lg">
                                        Default
                                    </button>
                                </div>
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-primary btn-lg"
                                            data-placement="top" data-original-title=".btn .btn-primary .btn-lg">
                                        Primary
                                    </button>
                                </div>
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-info btn-lg"
                                            data-placement="top" data-original-title=".btn .btn-info .btn-lg">
                                        &nbsp;Info&nbsp;
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-success btn-lg"
                                            data-placement="top" data-original-title=".btn .btn-success .btn-lg">
                                        Success
                                    </button>
                                </div>
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-warning btn-lg"
                                            data-placement="top" data-original-title=".btn .btn-warning .btn-lg">
                                        Warning
                                    </button>
                                </div>
                                <div class="col-xs-4">
                                    <button type="button" class="btn btn-danger btn-lg"
                                            data-placement="top" data-original-title=".btn .btn-danger .btn-lg">
                                        Danger
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-4 col-sm-offset-4">
                                    <button type="button" class="btn btn-inverse btn-lg"
                                            data-placement="top" data-original-title=".btn .btn-inverse .btn-lg">
                                        Inverse
                                    </button>
                                </div>
                            </div>
                ...
                <section class="widget">
                    ...
                    <div class="body">
                        <div class="well well-sm">
                            <blockquote class="blockquote-sm">Disabled state</blockquote>
                        ...
                        <div class="well well-sm">
                            <blockquote class="blockquote-sm">Button groups</blockquote>
                            <div class="row margin-bottom text-align-center">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-primary">
                        ...
                        <div class="well well-sm">
                            <blockquote class="blockquote-sm">Button dropdown menus</blockquote>
                            <div class="row margin-bottom text-align-center">
                                <div class="col-md-12">
                                    <div class="btn-group">
                        ...
                        <div class="well well-sm">
                            <blockquote class="blockquote-sm">Segmented dropdowns</blockquote>
                            <div class="row margin-bottom text-align-center">
                                <div class="col-md-12">
                                    <div class="btn-group">
                        ...
                        <div class="well well-sm">
                            <blockquote class="blockquote-sm">Checkboxes</blockquote>
                            <div class="row margin-bottom text-align-center">
                                <div class="col-md-12">
                        ...
                        <div class="well well-sm">
                            <blockquote class="blockquote-sm">Radio</blockquote>
                            <div class="row margin-bottom text-align-center">
                                <div class="col-md-12">
                                    <div class="btn-group" data-toggle="buttons">
                        ...
                        <div class="well well-sm">
                            <blockquote class="blockquote-sm">Block level buttons</blockquote>
                            <div class="row margin-bottom text-align-center">
