...
describe 'Plan ' do
  ...
  context  'ordinary user sign in ' do
    context 'plan list' do
      ...
      it ' can see plan' do
        #save_and_open_page
        expect have_content @plan1.name
      ...
      it ' add new plan', js: true do
        expect have_content 'Сохранить и приступить к добавлению этапов'
    ...
    context 'show plan' do
      ...
      it 'can see right form' do
        expect have_content @plan1.name
        expect have_content @plan1.goal
        expect have_content @plan1.content
      ...
      it ' can add comments '  do
        ...
        click_button 'send_post'
        expect have_content 'plan comment 1'
      end
    end
    context ' validation links' do
      it ' validate journal' do
        ...
        expect have_content 'plan comment 1'
        expect have_selector "a", @plan1.name
      end
