...
def validate_default_links_and_sidebar(project, user)
  ...
  expect(page).to have_link('go_to_life_tape', text: "1 #{I18n.t('stages.stage')} #{I18n.t('stages.life_tape')}", href: life_tape_posts_path(project))
  expect(page).to have_link('go_to_discontent', text: "2 #{I18n.t('stages.stage')} #{I18n.t('stages.discontent')}")
  expect(page).to have_link('go_to_concept', text: "3 #{I18n.t('stages.stage')} #{I18n.t('stages.concept')}")
  expect(page).to have_link('go_to_plan', text: "4 #{I18n.t('stages.stage')} #{I18n.t('stages.plan')}")
  expect(page).to have_link('go_to_estimate', text: "5 #{I18n.t('stages.stage')} #{I18n.t('stages.estimate')}")
