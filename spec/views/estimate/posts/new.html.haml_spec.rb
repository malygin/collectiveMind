...
describe "estimate/posts/new" do
  before(:each) do
    assign(:estimate_post, stub_model(Estimate::Post,
      :user_id => 1,
      :post_id => 1,
      :content => "MyText",
      :oppsh1 => 1,
  ...
  it "renders new estimate_post form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => estimate_posts_path, :method => "post" do
