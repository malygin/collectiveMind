...
describe Core::ProjectsController do
  ...
  describe "GET index" do
    it "assigns all discontent_aspects as @projects" do
      get :index
      assigns(:core_projects).should include(project)
    end
  end

  describe "GET show" do
    it "assigns the requested core_project as @core_project" do
      get :show, {:id => project}, valid_session
  ...
  describe "GET new" do
    it "assigns a new core_project as @core_project" do
      ...
      assigns(:project).should be_a_new(Core::Project)
    end
  end

  describe "change stages"do
   it "next stage"
   it "previous stage"
end
